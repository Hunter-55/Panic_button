...
var cooo = map.on('locationfound',e =>{
    ...
    socket.on("coords", function (latitude, logitude, nombreusuario){

        //distancia de los centro respeto al mensaje enviado
        var distance1 = (map.distance([latitude, logitude],coords))/1000;
